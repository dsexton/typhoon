...
In this tutorial, we'll create a Kubernetes v1.14.0-alpha.2 cluster on DigitalOcean with Container Linux.
...
module "digital-ocean-nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/container-linux/kubernetes?ref=v1.14.0-alpha.2"
...
nemo-controller-0  Ready   controller,master  10m  v1.14.0-alpha.2
nemo-worker-0      Ready   node               10m  v1.14.0-alpha.2
nemo-worker-1      Ready   node               10m  v1.14.0-alpha.2
```
