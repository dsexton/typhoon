...
In this tutorial, we'll network boot and provision a Kubernetes v1.14.0-beta.0 cluster on bare-metal with Container Linux.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/container-linux/kubernetes?ref=v1.14.0-beta.0"
...
```
# before v1.14.0-beta.0
$ ssh debug@node1.example.com
# after v1.14.0-beta.0
...
node1.example.com   Ready   controller,master  10m  v1.14.0-beta.0
node2.example.com   Ready   node               10m  v1.14.0-beta.0
node3.example.com   Ready   node               10m  v1.14.0-beta.0
```
