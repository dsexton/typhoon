...
In this tutorial, we'll create a Kubernetes v1.14.0-beta.2 cluster on AWS with Container Linux.
...
```tf
module "aws-tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/container-linux/kubernetes?ref=v1.14.0-beta.2"
...
ip-10-0-3-155  Ready   controller,master  10m  v1.14.0-beta.2
ip-10-0-26-65  Ready   node               10m  v1.14.0-beta.2
ip-10-0-41-21  Ready   node               10m  v1.14.0-beta.2
```
