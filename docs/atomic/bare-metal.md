...
In this tutorial, we'll network boot and provision a Kubernetes v1.14.0-beta.0 cluster on bare-metal with Fedora Atomic.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-atomic/kubernetes?ref=v1.14.0-beta.0"
