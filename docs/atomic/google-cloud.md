...
In this tutorial, we'll create a Kubernetes v1.14.0-beta.1 cluster on Google Compute Engine with Fedora Atomic.
...
module "google-cloud-yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/fedora-atomic/kubernetes?ref=v1.14.0-beta.1"
