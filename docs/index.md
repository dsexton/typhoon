...
* Kubernetes v1.14.0-beta.1 (upstream, via [kubernetes-incubator/bootkube](https://github.com/kubernetes-incubator/bootkube))
...
module "google-cloud-yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/container-linux/kubernetes?ref=v1.14.0-beta.1"
...
yavin-controller-0.c.example-com.internal  controller,master  Ready   6m   v1.14.0-beta.1
yavin-worker-jrbf.c.example-com.internal   node               Ready   5m   v1.14.0-beta.1
yavin-worker-mzdm.c.example-com.internal   node               Ready   5m   v1.14.0-beta.1
```
